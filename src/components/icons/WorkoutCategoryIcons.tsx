...
const Svg: React.FC<CategoryIconProps & { children: React.ReactNode }> = ({
  size = 24,
  color = 'currentColor',
  // Heavier than the original trace (18) so the icons hold their visual
  // weight next to Lucide icons at small (16–20px) rendered sizes.
  strokeWidth = 28,
  children,
  ...rest
}) => (
...
const legOutline = (
  <>
    ...
    <path d="M132 20C140 62 138 104 128 134" strokeWidth={22} />
    <path d="M156 20C162 58 160 98 150 126" strokeWidth={22} />
    <path d="M140 268C158 296 174 314 192 322" strokeWidth={22} />
  </>
);
...
export const PushIcon: React.FC<CategoryIconProps> = (props) => (
  <Svg {...props}>
    ...
    <path d="M40 140C58 100 128 82 176 96C186 78 196 60 210 60L210 42L302 42L302 60C316 60 326 78 336 96C384 82 454 100 472 140" />
    {/* collarbones */}
    <path d="M150 150L220 168" strokeWidth={24} />
    <path d="M362 150L292 168" strokeWidth={24} />
    {/* pec line */}
    ...
    <path d="M40 300C66 284 94 286 102 306C112 366 120 416 130 468L382 468C392 416 400 366 410 306C418 286 446 284 472 300" />
    {/* abs */}
    <path d="M256 286L256 432" strokeWidth={24} />
    <path d="M198 350C218 362 238 362 252 350" strokeWidth={24} />
    <path d="M260 350C274 362 294 362 314 350" strokeWidth={24} />
    <path d="M200 404C220 416 238 416 252 404" strokeWidth={24} />
    <path d="M260 404C274 416 294 416 312 404" strokeWidth={24} />
  </Svg>
);
